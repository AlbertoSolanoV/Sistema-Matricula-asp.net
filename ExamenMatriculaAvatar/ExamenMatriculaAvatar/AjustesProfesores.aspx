<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Ajustes.Master" CodeBehind="AjustesProfesores.aspx.vb" Inherits="ExamenMatriculaAvatar.Formulario_web17" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tutulosSecun">
        ...
        <asp:Label ID="Label4" runat="server" Text="Registro de Profesores"></asp:Label>
