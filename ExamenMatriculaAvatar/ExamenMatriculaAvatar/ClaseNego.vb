...
Public Class ClaseNego
    ...
    Dim tablaFacturaUna As New DataTable("facturauna")
    ...
    Dim tabProfe As New DataTable("profe")
...
#Region "Propiedades Estudiante Matricula"
    ...
    Public Property TabProfe1 As DataTable
        Get
            Return tabProfe
        End Get
        Set(value As DataTable)
    ...
    Public Property TablaFacturaUna2 As DataTable
        Get
            Return tablaFacturaUna
        End Get
        Set(value As DataTable)
            tablaFacturaUna = value
        End Set
    End Property
...
#Region "Facturacion"
    ...
    Sub verFacturaUna(idfactura As Integer)
        Try
            ClasBD.verFacturaUna(idfactura)
            tablaFacturaUna = ClasBD.TabFacturaUna1
...
#Region "Estudiates Cursos Info"
    ...
    Sub verPlanEstudio(id As Integer)

        Try
            ClasBD.verPlanEstudios(id)
            tabPlanEstudio = ClasBD.TabPlanEstudio1
...
#Region "Ajustes"
    ...
    Sub verProfes()
        Try
            ClasBD.verProfesores()

            tabProfe = ClasBD.TabProfes1
        Catch ex As Exception
            errores = ex.ToString()
        End Try
    End Sub
    ...
    Sub agregarCarrera(nombre As String, desc As String)
        ...
        Try
            ClasBD.agregarCarrera(nombre, desc)
        Catch ex As Exception
            errores = ex.ToString()
        End Try
    ...
    Sub agregarCursos(nombre As String, desc As String, costo As Integer, credi As Integer, requ As Integer, idcarrera As Integer, periodo As Integer)
        ...
        Try
            ClasBD.agregarCursos(nombre, desc, costo, credi, requ, idcarrera, periodo)
        Catch ex As Exception
            errores = ex.ToString()
        End Try
    ...
    Sub agregarDistribu(idcurso As Integer, idaula As Integer, idProfe As Integer, idhora As Integer, periodo As Integer)
        ...
        Try
            ClasBD.agregarDistribu(idcurso, idaula, idProfe, idhora, periodo)
        Catch ex As Exception
            errores = ex.ToString()
        End Try
...
#Region "Profes"
    ...
    Sub verProfersoresEstudiantes(idprofe As Integer)
        Try
            ClasBD.verProfersoresEstudiantes(idprofe)
            tabProfesEstudi = ClasBD.TabProfesEstudi1
        Catch ex As Exception
            errores = ex.ToString()
        End Try
    End Sub
    ...
    Sub IngresarNota(id As Integer, curso As Integer, nota As Integer)
        Try
            ClasBD.IngresarNota(id, curso, nota)
