...
Public Class Formulario_web14
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            nego.AgregarEstudiante(Convert.ToInt32(txtId.Text), txtNombre.Text, Convert.ToInt32(txtTelefono.Text), txtDireccion.Text, txtCorreo.Text, Convert.ToInt32(txtIDcarrera.Text))
